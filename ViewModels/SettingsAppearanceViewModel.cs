namespace NowListeningParserTool.ViewModels
{
        ...
        : NotifyPropertyChanged
    {
        ...
        public SettingsAppearanceViewModel()
        {
            ...
            //this._themes.Add(new Link { DisplayName = "tretja", Source = new Uri("/Assets/ModernUI.Theme1.xaml", UriKind.Relative) });
...
(string themeSourceDisplayName, Uri themeSourceUri, Color accentColor)
        {
